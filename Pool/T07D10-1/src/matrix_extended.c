...
void print_max_min_segment(const int *values, int rows, int columns);
void print_max_min_static(int data[][COLUMNS], int rows, int columns);
void print_max_min_2_3(int **data, int rows, int columns);
    ...
    if (error_code) {
        if (mode == 1) {
            ...
            if (error_code) {
                ...
                print_max_min_static(data, rows, columns);
            } else {
                printf("n/a");
            }
        } else if (mode == 2) {
            ...
            if (error_code) {
                ...
                print_max_min_2_3(dynamic_data, rows, columns);
            ...
            if (error_code) {
                ...
                print_max_min_segment(values, rows, columns);
...
void print_max_min_segment(const int *values, int rows, int columns) {
    for (int i = 0; i < rows; i++) {
        int max = values[columns * i];
        for (int j = 0; j < columns; j++) {
            if (values[columns * i + j] > max) {
                max = values[columns * i + j];
            }
        }
        if (i < rows - 1) {
            printf("%d ", max);
    ...
    for (int i = 0; i < columns; i++) {
        ...
        for (int j = 1; j < rows; j++) {
            if (values[i + j * columns] < min) {
                min = values[i + j * columns];
            }
        }
        if (i < columns - 1) {
            printf("%d ", min);
